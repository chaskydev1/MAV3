const Map<String, String> arAR = {
  ...
  "Save": "حفظ",
  "Please enter A/C Per Km Rate": "الرجاء إدخال سعر التكييف لكل كيلومتر",
  "Please enter Non A/C Per Km Rate": "الرجاء إدخال سعر الكيلومتر بدون مكيف",
  "Number": "الرقم",
  ...
  'Maximum allowed value is': "الحد الأقصى للقيمة المسموح بها ه",
  'Please enter a lower A/c value.': 'الرجاء إدخال قيمة حساب أقل.',
  'Please enter a lower Non A/c value.':
      'الرجاء إدخال قيمة أقل للحسابات غير الحسابية.',
  'Do you want to Accept or Reject the ride request?': 'هل تريد قبول أو رفض طلب الرحلة؟',
  'Reject': 'يرفض',
  'End Hold': 'إنهاء الانتظار',
  'Accept': 'يقبل',
  'Driver has ended the ride hold.': 'لقد أنهى السائق عملية حجز الرحلة.',
  'Ride Hold Ended': 'انتهت فترة الانتظار',
  'Ride hold has ended': 'انتهت فترة الانتظار',
  'Driver has accepted your ride hold request': 'لقد قبل السائق طلب حجز رحلتك',
  'Ride Hold Accepted': 'تم قبول حجز الرحلة',
  'Ride hold request has been rejected.': 'تم رفض طلب حجز الرحلة.',
  'Ride has been put on hold.': 'لقد تم تعليق الرحلة.',
};
