...
/// Helper para abrir navegación con Google Maps (intent en Android, web en ambos)
Future<void> _openNavigation(double? lat, double? lng) async {
  if (lat == null || lng == null) return;

  final Uri androidIntent = Uri.parse('google.navigation:q=$lat,$lng&mode=d');
  ...
  if (await canLaunchUrl(webUrl)) {
    ...
    ShowToastDialog.showToast("No se pudo abrir Google Maps");
  }
}
        ...
        return StreamBuilder<QuerySnapshot>(
          ...
          builder:
            ...
            return snapshot.data!.docs.isEmpty
                ? Center(
                    child: Text(
                      "No se encontraron viajes activos".tr,
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return InkWell(
                        onTap: () {
                          // Si quieres reactivar LiveTrackingScreen, descomenta y ajusta:
                          ...
                          //   }
                          // } else {
                          //   // Redirecciones por mapa externo con _openNavigation ya están en los botones
                          // }
                        },
                        child: Padding(
                              ...
                              child: Column(
                                children: [
                                  UserView(
                                    ...
                                    isAcOrNonAc:
                                        orderModel.service?.isAcNonAc == false
                                            ? null
                                  ...
                                  // Bloque: Viaje programado (si existe fecha)
                                            ...
                                            ? ButtonThem.buildBorderButton(
                                                ...
                                                onPress: () async {
                                                  ...
                                                  bool? confirm =
                                                    ...
                                                    builder: (context) {
                                                      return AlertDialog(
                                                        ...
                                                        content: Text(
                                                          "¿El pasajero ya llegó a su destino?"
                                                              .tr,
                                                          style: GoogleFonts
                                                              .poppins(
                                                            fontSize: 16,
                                                  ...
                                                  if (confirm == true) {
                                                    ...
                                                    // Pago en efectivo -> confirmar pago
                                                    if (controller
                                                                .paymentModel
                                                                .value
                                                                .cash
                                                      ...
                                                      // Notificar que el viaje terminó
                                                      await FireStoreUtils
                                                              .getCustomer(
                                                                  orderModel
                                                                      .userId
                                  ...
                                  // Botones principales según estado
                                  (orderModel.status == Constant.rideHold ||
                                      ...
                                      : orderModel.status == Constant.rideActive
                                          ? Column(
                                              children: [
                                                // Ir por el pasajero (a origen)
                                                ButtonThem.buildButton(
                                                  context,
                                                  title: "Ir por el Pasajero",
                                                  btnHeight: 45,
                                                  onPress: () async {
                                                    final lat = orderModel
                                                        .sourceLocationLAtLng
                                                        ?.latitude;
                                                    final lng = orderModel
                                                        .sourceLocationLAtLng
                                                        ?.longitude;
                                                            ...
                                                            padding:
                                                                const EdgeInsets
                                                                    ...
                                                                    vertical:
                                                                        15),
                                                            child: Text(
                                                              "¿Está seguro que quiere cancelar este viaje?"
                                                                  .tr,
                                                              style: GoogleFonts
                                                                  .poppins(
                                                                fontSize: 16,
                                  ...
                                  orderModel.status.toString() ==
                                      ...
                                      ? Align(
                                          ...
                                          child: Text(
                                            "¿Quieres aceptar o rechazar la solicitud de retención?"
                                                .tr,
                                            style: GoogleFonts.poppins(
                                  ...
                                  orderModel.status.toString() ==
                                      ...
                                      ? ButtonThem.buildButton(
                                          ...
                                          onPress: () async {
                                            ...
                                            orderModel.status =
                                                Constant.rideInProgress;
                                            DateTime acceptTime = orderModel
                                                .acceptHoldTime!
                                                .toDate();
                                            int rideHoldTimeInSeconds =
                                                DateTime.now()
                                                    .difference(acceptTime)
                                                    .inSeconds;
                                            int rideHoldTimeInMinutos =
                                                (rideHoldTimeInSeconds / 60)
                                                    .ceil();

                                            int chargePerInterval = int.parse(
                                                orderModel.service!
                                                    .holdingMinuteCharge
                                                    .toString());
                                            int holdingInterval = int.parse(
                                                orderModel
                                                    .service!.holdingMinute
                                                    .toString());

                                            int intervals =
                                                rideHoldTimeInMinutos ~/
                                                    holdingInterval;
                                            int extraTime =
                                                rideHoldTimeInMinutos %
                                                    holdingInterval;
                                            ...
                                            orderModel.rideHoldTimeMinutos =
                                                rideHoldTimeInMinutos
                                                    .toString();
                ...
                onPress: () async {
                  if (orderModel.otp.toString() ==
                        ...
                        if (orderModel.coupon!.type == "fix") {
                          ...
                          couponAmount =
                              ((double.parse(orderModel.finalRate.toString()) *
                                          double.parse(orderModel.coupon!.amount
                                              .toString())) /
                                      100)
                                  .toString();
                        }
                    ...
                    WalletTransactionModel adminCommissionWallet =
                      ...
                      note:
                          "Comisión de administración (${Constant.adminCommission?.amount}%)"
                              .tr,
                    );
